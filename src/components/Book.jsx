...
const Book = ({book}) => {
    ...
    return (
      <Link to={`../book/${book.isbn13}`}>
        ...
        <div className='bg-black bg-opacity-75 text-gray-300 absolute opacity-0 hover:opacity-100 inset-0 transition-opacity duration-200 px-6 py-4 flex flex-col'>
            <p>{book.title}</p>
            <br />
